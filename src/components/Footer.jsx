...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen py-5 px-20 bg-zinc-100 text-[#212121]">
      <div className="w-1/2 h-full relative">
        <h1 className="text-9xl tracking-tight leading-[9.6vw]">EYE</h1>
        <h1 className="text-9xl tracking-tight leading-[4vw]">-OPENING</h1>
        <div className="absolute left- bottom-10">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
      ...
      <div className="w-1/2">
        <h1 className="text-9xl tracking-tight uppercase leading-[9.6vw]">
          presentations
        </h1>
        <div className="social mt-10 text-md flex flex-col tracking-tight">
          <h2>S:</h2>
          <a href="#">Behance</a>
          <a href="#">Instagram</a>
          <a href="#">Facebook</a>
