    ...
    <div data-scroll data-scroll-section data-scroll-speed="-.3" className="w-full h-screen bg-zinc-900 pt-1">
              ...
              <div className="w-fit flex items-end overflow-hidden">
                {index === 1 && (
                  <motion.div
                    ...
                    className="bg-red-600 mr-[1vw] w-[9vw] rounded-md h-[5.7vw] -top-[0.2vw] relative"
                  ></motion.div>
                )}
                <h1 className="pt-[2vw] -mb-[1.5vw] text-[9vw] uppercase leading-[6vw] tracking-tight">
                  {items}
                </h1>
              </div>
            </div>
      ...
      <div className="border-t-[1px] border-zinc-800 mt-10 flex justify-between items-center px-20 py-5">
        {[
          ...
          return (
            <p
              className="text-md leading-none tracking-tight font-['Neue Montreal']"
              key={index}
            >
              {items}
            </p>
        ...
        <div className="start flex justify-center items-center gap-2">
          <div className="border-[2px] font-light text-md border-zinc-500 uppercase rounded-full py-2 px-5">
            start the project
          </div>
